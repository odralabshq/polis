...
"
...

    {
        ...
        echo "      - ./agents/${NAME}/.generated/${NAME}.service.sha256:/tmp/agents/${NAME}/${NAME}.service.sha256:ro"
        echo "      - ./agents/${NAME}/.generated/${NAME}.env:/tmp/agents/${NAME}/${NAME}.env:ro"
...
"
...

    {
        ...
        echo ""
        if [[ -n "${SPEC_INIT}" ]]; then
            echo "ExecStartPre=/tmp/agents/${NAME}/${SPEC_INIT}"
        fi
