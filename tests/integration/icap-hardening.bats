...
setup_file() {
    ...
    export SQUIDCLAMAV_CONF="${PROJECT_ROOT}/config/squidclamav.conf"
    export CLAMD_CONF="${PROJECT_ROOT}/config/clamd.conf"
    export CICAP_CONF="${PROJECT_ROOT}/config/c-icap.conf"
}
...
@test "icap-hardening: ICAP process is running as c-icap user" {
